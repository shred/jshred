...
public abstract class AbstractTagProxy<T extends JspTag> implements JspTag, ProxiedTag<T> {
    ...
    /**
     * Gets the {@link BeanFactory} from the given {@link JspContext}. The
     * default implementation automagically finds a {@link BeanFactory} that was
     * previously set by a {@link FrameworkServlet}. The result is cached.
     * 
     * @param jspContext
