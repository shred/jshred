...
import org.shredzone.jshred.spring.taglib.annotation.BeanFactoryReference;
...
import org.shredzone.jshred.spring.taglib.proxy.BodyTagProxy;
import org.shredzone.jshred.spring.taglib.proxy.IterationTagProxy;
import org.shredzone.jshred.spring.taglib.proxy.SimpleTagProxy;
import org.shredzone.jshred.spring.taglib.proxy.TagProxy;
import org.springframework.util.StringUtils;

/**
 * A javac processor that scans for tag annotations and creates proxy classes that
 * allow to use Spring in tag library implementations.
 * 
 * @author Richard Körber {@literal <dev@shredzone.de>}
 * @version $Id: TaglibProcessor.java 430 2010-04-21 21:58:20Z shred $
 */
@SupportedAnnotationTypes("org.shredzone.jshred.spring.taglib.annotation.*")
public class TaglibProcessor extends AbstractProcessor {
    ...
    /**
     * Computes the name of a tag. If there was a name given in the annotation, it
     * will be used. Otherwise, a name is derived from the class name of the tag
     * class, with a "Tag" suffix removed.
     * 
     * @param annotation
    ...
    /**
     * Computes the name of an attribute. If there was a name given in the
     * annotation, it will be used. Otherwise, a name is derived from the field
     * name where the attribute is stored.
     * 
     * @param annotation
    ...
    /**
     * Generates a proxy class that connects to Spring and allows all Spring
     * features like dependency injection in the implementing tag class.
     * 
     * @param tag
